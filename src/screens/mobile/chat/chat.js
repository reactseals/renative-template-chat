        ...
        <View style={styles.loginContainer}>
          {avatarUserLocal ? (
            ...
            <TouchableOpacity
              onPress={() => this.setAvatar()}
            >
              <Image style={{ width: 100, height: 100 }} source={require('../../../../platformAssets/runtime/avatarIcon.png')} />
            </TouchableOpacity>
          )}
          ...
          <View style={styles.chatContainer}>
            ...
            >
              ...
              {typingListener && nickname !== userInfo.nickname ? (
                <Image style={{ width: 40, height: 40, marginLeft: 10 }} source={require('../../../../platformAssets/runtime/typingAnimation.gif')} />
              ) : (
                null
              )}
            </ScrollView>
